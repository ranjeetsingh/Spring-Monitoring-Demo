package com.monitoring.com.service;
...
public class StudentServiceDelegate {
	...
	@HystrixCommand(fallbackMethod = "method_Fallback")
	...
	@SuppressWarnings("unused")
	private String method_Fallback() {

		System.out.println("Method Service is down!!! fallback route enabled...");
